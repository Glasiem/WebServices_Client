...
public interface WebServiceSoap {
     ...
     *     returns boolean
     */
    @WebMethod(operationName = "DeleteDuplicateRows", action = "http://tempuri.org/DeleteDuplicateRows")
    @WebResult(name = "DeleteDuplicateRowsResult", targetNamespace = "http://tempuri.org/")
    @RequestWrapper(localName = "DeleteDuplicateRows", targetNamespace = "http://tempuri.org/", className = "org.example.generated.DeleteDuplicateRows")
    @ResponseWrapper(localName = "DeleteDuplicateRowsResponse", targetNamespace = "http://tempuri.org/", className = "org.example.generated.DeleteDuplicateRowsResponse")
    public boolean deleteDuplicateRows(
        @WebParam(name = "tableIndex", targetNamespace = "http://tempuri.org/")
        int tableIndex);
